...
const UserCreate = () => (
    <Create>
        ...
        >
            <SectionTitle label="resources.customers.fieldUsers.identity" />
            ...
            <Separator />
            <SectionTitle label="resources.customers.fieldUsers.address" />
            <TextInput
                source="address"
                multiline
                fullWidth
            ...
            <Separator />
            <SectionTitle label="resources.customers.fieldUsers.password" />
            <Box display={{ xs: 'block', sm: 'flex' }}>
                <Box flex={1} mr={{ xs: 0, sm: '0.5em' }}>
